...
public final class Constants {
    ...
    // Базові повідомлення та константи
    ...
    public final static String MENU_RETURN_MSG = "Returning to main menu...";

    // Повідомлення для юзернейму
    public final static String EMPTY_USERNAME_MSG = "Empty username input! Input required...";

    // Regexes для номеру телефону в даному форматі: xxx xxx-xxxx
